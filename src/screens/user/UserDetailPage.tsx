...
import { Mail, Calendar, Award, TrendingUp, MessageSquare, Eye, Users, Heart } from 'lucide-react'
...
export function UserDetailPage({ isOwnProfile = true, userId }: UserDetailPageProps) {
  ...
  const targetUserId = isOwnProfile ? currentUser?.id : Number(userId ?? routeUserId)
              ...
              {isOwnProfile && (
                <>
                  <TabsTrigger value="mytopics" asChild>
                    <Link href="/usercenter/mytopics/1">我的主题</Link>
                  </TabsTrigger>
                  <TabsTrigger value="myposts" asChild>
                    <Link href="/usercenter/myposts/1">我的回复</Link>
                  </TabsTrigger>
