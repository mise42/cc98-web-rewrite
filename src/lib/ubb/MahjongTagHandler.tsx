...
export default class MahjongTagHandler extends Ubb.RecursiveTagHandler {
  ...
  getCartoonUrl(mahjongId: string) {
    switch (mahjongId) {
      ...
      case '049':
      case '096':
        return `/static/images/mahjong/carton2017/${mahjongId}.gif`
      default:
        return `/static/images/mahjong/carton2017/${mahjongId}.png`
    }
  }
  ...
  getFaceUrl(mahjongId: string) {
    switch (mahjongId) {
      ...
      case '175':
      case '206':
        return `/static/images/mahjong/face2017/${mahjongId}.gif`
      default:
        return `/static/images/mahjong/face2017/${mahjongId}.png`
    }
  }
