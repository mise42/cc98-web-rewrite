...
import { ApiError, hasStatus } from "@/services/client";
...
export function TopicDetailPage() {
  ...
  const displayPosts = React.useMemo(
    () => (viewMode === "pagination" ? (pagedPosts ?? []) : allPosts),
    [allPosts, pagedPosts, viewMode],
  );
  ...
  return (
    <div className="container mx-auto px-4 py-6 max-w-[900px]">
      ...
      {/* 视图模式切换 */}
      <div className="mb-4">
        <ViewModeToggle mode={viewMode} onModeChange={(mode) => updateURL(1, mode)} />
      </div>
