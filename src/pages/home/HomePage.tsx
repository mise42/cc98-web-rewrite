            ...
            <Card className="shadow-md bg-gradient-to-br from-primary/10 to-transparent border-primary/20">
              ...
              <CardContent className="p-4">
                ...
                <div className="mt-4 pt-4 border-t border-border/60 space-y-2">
                  <div className="text-xs font-medium text-muted-foreground">关注</div>
                  <Link
                    to="/following-topics"
                    className="flex items-center justify-between rounded-lg border border-border/60 bg-background/70 px-3 py-2 text-sm text-foreground hover:border-primary/50 hover:bg-muted/50 transition-colors"
                  >
